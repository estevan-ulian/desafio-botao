...
import type { StepSharedProps } from "../types/stepper-type";
	...
	return (
		<Button
			...
			className={cn(
				...
				"data-[active=true]:bg-primary data-[active=true]:border-primary data-[active=true]:text-foreground",
				"data-[current=true]:border-primary data-[current=true]:bg-primary-foreground dark:data-[current=true]:bg-primary",
