        ...
        return (
            <div
                ...
                className={cn(
                    ...
                    "[&:not(:last-child)]:after:content-[''] [&:not(:last-child)]:after:h-[2px] [&:not(:last-child)]:after:bg-input",
                    ...
                    variant === "line" &&
                        "flex-col flex-1 border-t-[3px] data-[active=true]:border-buslogbbg-primary",
