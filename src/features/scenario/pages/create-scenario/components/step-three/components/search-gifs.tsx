		...
		<div className="w-full">
							...
							<div className="mt-4 flex flex-col gap-2 w-full">
								{error && (
									<div className="col-span-3 text-red-500">
										Ocorreu um erro ao carregar os GIFs. Tente novamente mais
										tarde.
									</div>
								)}
								{isLoading && searchTerm && (
									<div className="col-span-3">Carregando gifs...</div>
								)}
			...
			{selectedGif && (
				<div className="mt-8 text-center">
					<p className="mb-4 text-lg font-semibold">Você escolheu este GIF:</p>
					<img
